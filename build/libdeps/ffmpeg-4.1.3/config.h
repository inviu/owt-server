...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-yasm --enable-asm --prefix='D:/workspace/owt-server/build/libdeps/build' --enable-shared --disable-static --disable-libvpx --disable-vaapi --enable-libfdk-aac --enable-nonfree --disable-doc --disable-programs --extra-cflags=-I../build/include --extra-ldflags='-LIBPATH:../build/lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "D:/workspace/owt-server/build/libdeps/build/share/ffmpeg"
#define AVCONV_DATADIR "D:/workspace/owt-server/build/libdeps/build/share/ffmpeg"
#define CC_IDENT "用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.16.27038 版"
