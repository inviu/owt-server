...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --arch=x86_64 --enable-yasm --enable-asm --prefix='D:/workspace/owt-server/build/libdeps/build' --enable-shared --disable-static --disable-libvpx --disable-vaapi --enable-libfdk-aac --enable-nonfree --disable-doc --disable-programs --extra-cflags=-I../build/include --extra-ldflags='-LIBPATH:../build/lib'
prefix=D:/workspace/owt-server/build/libdeps/build
...
CC_IDENT=用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.16.27038 版
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=cl
...
CFLAGS=-fPIC -nologo -I../build/include   -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -utf-8
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS= -nologo 
ASFLAGS= -nologo -I../build/include -Z7
...
DEPWINDRES=cl
DOXYGEN=doxygen
LDFLAGS= -LIBPATH:../build/lib -nologo -debug
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=fdk-aac.lib ole32.lib user32.lib
